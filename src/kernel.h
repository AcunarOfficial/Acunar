...
#ifndef ACUNAR_KERNEL_H
#define ACUNAR_KERNEL_H

#include "main.h"

// MODIFIER_INTERVAL: time to elapse before new modifier is computed
static const unsigned int MODIFIER_INTERVAL = 4 * 60 * 60;	// equates to GetStakeModifierSelectionInterval = 5.8792175 days
