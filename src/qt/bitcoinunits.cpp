...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("ACU");
    case mBTC: return QString("mACU");
    case uBTC: return QString::fromUtf8("μACU");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString("Acunars");
    case mBTC: return QString("Milli-Acunars (1 / 1,000)");
    case uBTC: return QString("Micro-Acunars (1 / 1,000,000)");
    default: return QString("???");
    }
}
