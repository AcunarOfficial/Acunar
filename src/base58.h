 ...
 * acunar public-key-hash-addresses have version 55 (or 111 testnet).
...
public:
    enum
    {
        PUBKEY_ADDRESS = 23,  // coin: addresses begin with 'A'
        SCRIPT_ADDRESS = 83, // coin: addresses begin with 'a'
