...
static unsigned char pchMessageStartTestNew[4] = { 0xd1, 0xa5, 0xed, 0xcd };
static unsigned int nMessageStartTestSwitchTime = 1346200000;

// Acunar message start (switch from Bitcoin's in v0.2)
static unsigned char pchMessageStartBitcoin[4] = { 0xf9, 0xbe, 0xb4, 0xd9 };
static unsigned char pchMessageStartAcunar[4] = { 0x74, 0x3c, 0x3a, 0xb9 };
...
void GetMessageStart(unsigned char pchMessageStart[], bool fPersistent)
{
    if (fTestNet)
        ...
        memcpy(pchMessageStart, (fPersistent || GetAdjustedTime() > nMessageStartSwitchTime)? pchMessageStartAcunar : pchMessageStartBitcoin, sizeof(pchMessageStartAcunar));
}
