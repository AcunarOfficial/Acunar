...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Acunar " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"seed0", "seed0.93p4of.com"},
    {"seed1", "seed1.93p4of.com"},
    {"seed2", "seed2.93p4of.com"},
    {"seed3", "seed3.93p4of.com"},
    {"seed4", "seed4.93p4of.com"},
    {"seed5", "seed5.93p4of.com"},
    {"seed6", "seed6.93p4of.com"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Acunar is probably already running."), addrBind.ToString().c_str());
        else
