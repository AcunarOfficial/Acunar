...
// acunar: remove transaction from mempool
...
// acunar: reserve balance from being staked for network protection
...
void StartRPCThreads()
{
        ...
        (mapArgs["-rpcuser"] == mapArgs["-rpcpassword"]))
    {
        ...
        string strWhatAmI = "To use acunard";
