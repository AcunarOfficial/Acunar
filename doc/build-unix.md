...
UNIX BUILD NOTES FOR ACUNAR
====================

To build in Terminal on Debian based Linux
---------------------

	git clone https://github.com/acunar/acunar
	cd acunar
...
This will build Acunar-Qt as well if the dependencies are met.
...
Note: Currently, there is no acunar ebuild available in overlay 
...
Notes
-----
The release is built with GCC and then "strip acunard" to strip the debug
